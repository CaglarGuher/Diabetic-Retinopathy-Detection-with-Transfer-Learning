...
def main(args):
    ...
    for model_name in model_dict:
        ...
        model = optimize(model, model_name, train, test, device, data_label, args.train_test_path,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tt_samp_size",type = int,default =200,help="how many train data you want to put ")
